...
require('constant.php');
	...
	$toEmail = "info@bathroomrenovationscork.ie";
	$mailHeaders = "From: " . $user_name . "<" . $user_email . ">\r\n";
	$mailBody = "A new customer has submitted an enquiry through contact form on your website. The details are as follows: \n";
	...
	if (mail($toEmail, "Enquiry From Website", $mailBody, $mailHeaders)) {
